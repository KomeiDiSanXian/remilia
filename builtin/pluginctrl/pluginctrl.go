...
func (p *Plugin) registerCommands(ctx *plugin.SetupContext) {
	...
	ctx.OnCommand(groupEvent, o.commandPrefix+o.enableCmd, p.handleEnable, eventctx.OnMentionedBotOrNoMentions())
	ctx.OnCommand(groupEvent, o.commandPrefix+o.disableCmd, p.handleDisable, eventctx.OnMentionedBotOrNoMentions())
	ctx.OnCommand(groupEvent, o.commandPrefix+o.listCmd, p.handleServiceList, eventctx.OnMentionedBotOrNoMentions())
	ctx.OnCommand(groupEvent, o.commandPrefix+o.globalEnableCmd, p.handleGlobalEnable, eventctx.OnMentionedBotOrNoMentions())
	ctx.OnCommand(groupEvent, o.commandPrefix+o.globalDisableCmd, p.handleGlobalDisable, eventctx.OnMentionedBotOrNoMentions())
	ctx.OnCommand("", o.commandPrefix+o.userDisableCmd, p.handleUserDisable, eventctx.OnMentionedBotOrNoMentions())
	ctx.OnCommand("", o.commandPrefix+o.userEnableCmd, p.handleUserEnable, eventctx.OnMentionedBotOrNoMentions())
	ctx.OnCommand("", o.commandPrefix+o.silenceCmd, p.handleSilence, eventctx.OnMentionedBotOrNoMentions())
	ctx.OnCommand("", o.commandPrefix+o.resumeCmd, p.handleResume, eventctx.OnMentionedBotOrNoMentions())
	ctx.OnCommand("", o.commandPrefix+o.banCmd, p.handleBan, eventctx.OnMentionedBotOrNoMentions())
	ctx.OnCommand("", o.commandPrefix+o.unbanCmd, p.handleUnban, eventctx.OnMentionedBotOrNoMentions())
	ctx.OnCommand("", o.commandPrefix+o.flipDefaultCmd, p.handleFlipDefault, eventctx.OnMentionedBotOrNoMentions())
}
